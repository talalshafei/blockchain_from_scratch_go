...
const (
	protocol      = "tcp"
	nodeVersion   = 1 // only version in this small project
	commandLength = 12
)
...
func sendTx(addr string, txn *Transaction) {
...
// TODO: Instead of running UTXOSet.Reindex(), UTXOSet.Update(block) should be used,
...
func handleInv(request []byte, _ *Blockchain) {
	var buff bytes.Buffer
	var payload Inv
...
// TODO: Again, UTXOSet.
// Update should be used instead of UTXOSet.Reindex
